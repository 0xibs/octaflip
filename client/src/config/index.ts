...
const TORII_RELEASE_URL = import.meta.env.VITE_TORII_RELEASE_URL;
const TORII_MAINNET_URL = import.meta.env.VITE_TORII_MAINNET_URL;

const RPC_SEPOLIA_URL = import.meta.env.VITE_RPC_SEPOLIA_URL;
const RPC_RELEASE_URL = import.meta.env.VITE_RPC_RELEASE_URL;
...
const OCTAFLIP_RELEASE_WORLD_ADDRESS = import.meta.env
  .VITE_OCTAFLIP_RELEASE_WORLD_ADDRESS;
...
const OCTAFLIP_WORLD_ADDRESS =
  ENV == ENV_OPTIONS.MAINNET
    ...
    : ENV == ENV_OPTIONS.RELEASE
    ? OCTAFLIP_RELEASE_WORLD_ADDRESS
    : null;
